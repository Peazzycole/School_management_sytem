        ...
        <div class="card-group justify-content-center">
            <?php if ($row) : ?>
                <form action="" method="POST" style="width: 330px;">
                    ...
                    <input readonly autofocus type="text" value="<?= get_var('school', $row->school) ?>" class="form-control" name="school" placeholder="School Name"><br>
            ...
            <?php else : ?>
                <div class="text-center">
                    <h3>The school was not found</h3>
                    <a href="<?= ROOT ?>/schools">
